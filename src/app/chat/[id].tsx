...
export default function ChatScreen() {
    ...
    const room = useQuery((api as any).rooms.getRoom, { roomId });
    const messages = useQuery((api as any).messages.listMessages, { chatRoomId: roomId });
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Text
                    className="text-white text-lg font-semibold flex-1 text-center mx-3"
                    numberOfLines={1}
                >
                    {room.title}
                </Text>
                ...
                <TouchableOpacity
                    onPress={() => router.push(`/settings/${roomId}` as any)}
                    className="p-1.5"
                    hitSlop={{ top: 12, bottom: 12, left: 12, right: 12 }}
                >
                    <Ionicons
